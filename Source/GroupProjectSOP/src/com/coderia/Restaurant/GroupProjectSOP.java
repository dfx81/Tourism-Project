...
public class GroupProjectSOP extends Content {
    ...
    public void buildUI(Client yes) {
        ...
        b6.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                client.sendRequest("/restaurant-w");
            }
        });
    }

    // You and jason are copying each other or what???
    //File f = new File("/Users/HP/Desktop/customerList.txt");
    int ln;
    String data;

    // All of these are the exact same code
    /*void createFolder() {
        if (!f.exists()) {
            f.mkdirs();
        }
    ...
    void addData(String inputdate, String inputname, String inputcontactnumber, double inputtemperature) {
        ...
        client.sendRequest("/restaurant-r");
        ...
        data += "Name:" + inputname + "\n";
        data += "Contact Number:" + inputcontactnumber + "\n";
        data += "Temperature:" + inputtemperature + "\n";
    }
